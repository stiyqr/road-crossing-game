...
class MainMenu(Frame):
    def __init__(self, parent, controller):
        ...
        play_button = ImageButton(
            ...
            command=lambda: self.show_game_frame(controller)
        )
        #play_button.place(x=467,y=238)
        play_button.place(x=463,y=235)

        quit_button = ImageButton(
            controller, 
            image_path="images\quit_button.png", 
            command=self.close_game_frame
        )
        #quit_button.place(x=460,y=370)
        quit_button.place(x=460,y=366)
    ...
    def show_game_frame(self, controller):
...
class ImageButton(Frame):
    def __init__(self, parent, image_path, command=None):
        ...
        self.image_button.config(width=378, height=120)
